...
public class IridessaCoinsWarning extends GameObject {
	...
	public IridessaCoinsWarning(State state, Control control) {
	...
	public void draw(Graphics g) {
	    ...
	    g.drawString("YOU NEED MORE", 665, 370);
	    g.drawString("COINS FOR THIS!", 668, 380);
	}
