...
public class Iridessa extends GameObject
	...
	public Iridessa(State state, Control control) {
		...
		y = control.getMouseY();
			...
			if (cooldownTime <= 0) {
				...
				if (state.getNearestEnemy(new Point(x, y)) == null) cooldownTime = 2.0; 
					...
					state.addGameObject(new IridessaDust(state, control, new Point(x, y)));
					cooldownTime = 2.0;
...
//						
	...
	public void draw(Graphics g) {
		g.drawImage(control.getImage("iridessa.png"), x, y, null);}
