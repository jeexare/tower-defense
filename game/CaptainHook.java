/**
 * Constructs a CaptainHook GameObject.
 * 
 * 
...
public class CaptainHook extends Enemy{
	...
	public CaptainHook(State state, Control control) {
	...
	public void update(double elapsedTime) {
		...
		if (percentage > 1) { // If the percentage gets to a 100%
			...
			state.addGameObject(new CaptainHook(state, control)); // A new object is created 
	...
	public void draw(Graphics g) {
        ...
        g.drawImage(control.getImage("captainhook.png"), loc.x - 20, loc.y - 30, null);
	}
