/**
 * Constructs a RosettaDust GameObject.
 * 
 * 
...
public class RosettaDust extends GameObject {
	double deltaX;
	double deltaY;
	double angle;
	double speed = 8;
	...
	public RosettaDust(State state, Control control, Point posTower) {
	...
	public void update(double elapsedTime) {
		...
		if (currentX >= posEnemy.x - 30 && currentX <= posEnemy.x + 30
			...
			// If the enemy is a CaptainHook and has been hit 10 times
	...
	public void draw(Graphics g) {
		...
		g.fillOval((int) currentX + 5, (int) currentY + 5, 5, 5);
		g.fillOval((int) currentX - 7, (int) currentY - 7, 2, 2);
