/**
 * Constructs a PirateShip GameObject.
 * 
 * 
...
public class PirateShip extends Enemy{
	...
	public PirateShip(State state, Control control) {
	...
	public void update(double elapsedTime) {
		...
		if (percentage > 1) { // If the percentage gets to a 100%
			...
			state.addGameObject(new PirateShip(state, control)); // A new object is created
	...
	public void draw(Graphics g) {
        ...
        g.drawImage(control.getImage("pirateship.png"), loc.x - 30, loc.y - 34, null);
	}
