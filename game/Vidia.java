...
public class Vidia extends GameObject
	...
	private double cooldownTime = 5.0; // Time not allowed to fire after being placed of firing once
	...
	public Vidia(State state, Control control) {
	...
	public void update(double elapsedTime) {
		...
		y = control.getMouseY();
			...
			if (cooldownTime <= 0) {
				...
				if (state.getNearestEnemy(new Point(x, y)) == null) cooldownTime = 5.0; 
					...
					state.addGameObject(new VidiaDust(state, control, new Point(x, y)));
					cooldownTime = 5.0;
...
//						
	...
	public void draw(Graphics g) {
		g.drawImage(control.getImage("vidia.png"), x, y, null);}
