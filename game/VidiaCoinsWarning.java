...
public class VidiaCoinsWarning extends GameObject {
	...
	public VidiaCoinsWarning(State state, Control control) {
	...
	public void draw(Graphics g) {
	    ...
	    g.drawString("YOU NEED MORE", 665, 520);
	    g.drawString("COINS FOR THIS!", 668, 530);
	}
