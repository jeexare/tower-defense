...
public class TinkerCoinsWarning extends GameObject {
	...
	public TinkerCoinsWarning(State state, Control control) {
	...
	public void draw(Graphics g) {
	    ...
	    g.drawString("YOU NEED MORE", 665, 320);
	    g.drawString("COINS FOR THIS!", 668, 330);
	}
